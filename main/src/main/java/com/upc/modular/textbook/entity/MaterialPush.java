...
@TableName("material_push")
@ApiModel(value = "MaterialPush对象", description = "")
public class MaterialPush {
    ...
    @ApiModelProperty("推送资料的名称")
    @TableField("name")
    private String name;

    @ApiModelProperty("推送资料的类型（如思想政治理论文章、时事政治解读等）")
    @TableField("type")
    private String type;

    @ApiModelProperty("推送资料的简介")
    @TableField("introduction")
    private String introduction;

    @ApiModelProperty("推送资料的详细内容")
    @TableField("content")
